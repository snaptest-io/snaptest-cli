...
Actions.forEach((action) => {
  ConstantMap[action.constant] = action;
});
...
Actions.forEach((action) => {
  ...
  var category = _.find(Categories, {label: action.category});
  category.actions.push(action);

  var categoryMap = CategoryMap[action.category];
...
module.exports = {
  All: Actions,
  ByConstant: ConstantMap,
  ByCategories: Categories,
  ByCagetoryMap: CategoryMap
};
